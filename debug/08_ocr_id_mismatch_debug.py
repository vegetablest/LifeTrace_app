...
# -*- coding: utf-8 -*-
"""
调试OCR ID不匹配问�?通过API检查文本和图像向量数据库中的OCR ID格式
"""
...
def main():
    try:
        ...
        # 测试不同权重的多模态搜�?        test_cases = [
            {"text_weight": 1.0, "image_weight": 0.0, "name": "纯文本搜�?},
            {"text_weight": 0.0, "image_weight": 1.0, "name": "纯图像搜�?},
