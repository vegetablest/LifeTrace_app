...
class SimpleHeartbeatSender:
    ...
    def __init__(self, service_name: str, manager_host: str = '127.0.0.1', manager_port: int = 9999):
...
def init_service_heartbeat(service_name: str, auto_start: bool = True) -> SimpleHeartbeatSender:
    """初始化服务心跳发送器"""
